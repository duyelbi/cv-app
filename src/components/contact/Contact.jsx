                    ...
                    <div className="row">
                        <div className="col-lg-12">
                            <div className="text-left">
                                ...
                                <p className="m-0">It is a long established fact that a reader will be distracted by the
                                    readable content</p>
                            </div>
                        </div>
                    </div>
                ...
                <div className="section-content flex-grow-1">
                    <div className="row">
                        <div className="col-sm-4">
                            <div
                                className="d-flex flex-row flex-sm-column flex-md-row justify-content-md-center mb-3 text-left text-sm-center text-md-left">
                        ...
                        <div className="col-lg-12">
                            <form action="php/form.php" method="post" id="contact-form">
                                <div className="row">
                                    ...
                                    <div className="col-lg-12 mt-3">
                                        <div className="form-group">
                                            <textarea name="text" id="text" rows="6" className="form-control"
                                                required=""></textarea>
                                            <label>Message</label>
                                        </div>
                                    </div>
